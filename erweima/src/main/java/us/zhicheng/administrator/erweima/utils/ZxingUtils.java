package us.zhicheng.administrator.erweima.utils;
...
public class ZxingUtils {
    ...
    public static Bitmap Create2DCode(String str, Bitmap logBitmap) throws WriterException {

        //把获取到的文字编码格式转换为UTF-8就不会出现生成的二维码是乱码了
